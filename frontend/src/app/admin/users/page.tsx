      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="mt-4 flex gap-4">
          <button
            ...
            className={`px-4 py-2 rounded-lg ${filterActive === undefined ? 'bg-blue-600 text-white' : 'bg-gray-200'}`}
          >
            All Users
          </button>
          <button
            onClick={() => setFilterActive(true)}
            className={`px-4 py-2 rounded-lg ${filterActive === true ? 'bg-green-600 text-white' : 'bg-gray-200'}`}
          >
            Active
          </button>
          <button
            onClick={() => setFilterActive(false)}
            className={`px-4 py-2 rounded-lg ${filterActive === false ? 'bg-red-600 text-white' : 'bg-gray-200'}`}
          >
            Suspended
          </button>
        </div>
