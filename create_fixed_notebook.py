#!/usr/bin/env python3
"""Create fixed institutional books loader notebook."""
...
notebook = {
    "cells": [
        ...
        },
        {
            ...
            "metadata": {},
            "outputs": [],
            "source": ["!pip install datasets huggingface-hub psycopg2-binary requests pandas -q"]
        },
        {
            "cell_type": "markdown",
            "metadata": {},
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## Step 3: Configuration (⚠️ UPDATE YOUR TOKEN)"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## Step 4: Helper Functions"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## Step 5: Database Connection"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## Step 6: Load Progress Tracking"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## Step 7: Login to HuggingFace"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## Step 8: Load Dataset and Process Books"]
        },
        {
            "cell_type": "code",
            "execution_count": None,
...
# Write notebook
with open('load_institutional_books.ipynb', 'w') as f:
    json.dump(notebook, f, indent=1)

print("✅ Created complete notebook with all cells")
